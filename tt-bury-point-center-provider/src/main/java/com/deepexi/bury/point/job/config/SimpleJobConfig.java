...
package com.deepexi.bury.point.job.config;
...
public class SimpleJobConfig {
    ...
    @Resource
    private SimpleJob reSendJob;

    @Bean(initMethod = "init")
    public JobScheduler reSendScheduledJob(@Value("${elasticJob.reSendJob.cron}") final String cron,
                                           @Value("${elasticJob.reSendJob.shardingTotalCount}") final int shardingTotalCount,
